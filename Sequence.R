...
data = read.csv( "/Users/luis/Documents/Capstone/Salinas High School/Data (Game)/SHS_HomeGame_20191210.csv", header=FALSE )[,1]
data = gsub( "\t", "", data )
...
touch = good = goal = rep( NA, n ) ### STORAGE
...
data.player = data.frame( player, touch, good, p.good, goal )
data.player = data.player[ order(player), ]
data.player

pdf( "/Users/luis/Documents/Capstone/Salinas High School/Data (Game)/Graphs/SHS_HomeGame_20191210.pdf", height=8, width=14 )
